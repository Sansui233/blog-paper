import { mdLength } from "../lib/md-length";
...
describe("mdLength", () => {
  ...
  it("注释不计入", () => {
    expect(mdLength("hello <!-- comment --> world")).toBe(10);
  });
  ...
  it("混合内容", () => {
    expect(mdLength("**[百度](https://baidu.com)** 和 ![猫](cat.jpg)")).toBe(4);
  });
